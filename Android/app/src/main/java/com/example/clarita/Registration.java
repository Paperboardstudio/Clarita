...
public class Registration extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pincode = (TextInputLayout) findViewById(R.id.CountryCode);
        Statespin = (Spinner) findViewById(R.id.State);
        Cityspin = (Spinner) findViewById(R.id.Localaddress);
                            ...
                            if (task.isSuccessful()) {
                                ...
                                databaseReference.setValue(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        ...
                                        firebaseDatabase.getInstance().getReference("Customer").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).setValue(hashMap1).addOnCompleteListener(new OnCompleteListener<Void>() {
                                            @Override
                                            public void onComplete(@NonNull Task<Void> task) {
                                                mDialog.dismiss();
    ...
    public boolean isValid() {
        ...
        boolean isValid = false, isValidlocaladd = false, isValidlname = false,
        ...
        isValid = (isValidarea && isValidconfpassword && isValidpassword &&
                ...
                isValidname && isValidlocaladd && isValidlname) ? true : false;
        return isValid;
